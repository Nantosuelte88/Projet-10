...
from .views import ProjectViewset, ContributorViewset, \
    IssueViewset, CommentViewset, ApiHome, ProjectIssuesListView
...
urlpatterns = [
    ...
    path('projects/<int:project_id>/issues/', ProjectIssuesListView.as_view({'get': 'list'}), name='project-issues-list'),
